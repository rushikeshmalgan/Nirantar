...
import rampWalkImg from '../assets/ramp-walk.jpg';
import surpriseImg from '../assets/surprise.jpg';
import soloGroupImg from '../assets/solo-group.jpg';
import powadaImg from '../assets/powada.jpg';
    ...
    <div className="home-page">
      ...
      <nav>
        ...
        <ul className={`nav-links ${isMobileMenuOpen ? 'open' : ''}`}>
          ...
          <li><a href="#events" onClick={() => setIsMobileMenuOpen(false)}>Events</a></li>
          <li><button onClick={() => { setIsMobileMenuOpen(false); navigate('/admin'); }} className="nav-admin">Admin</button></li>
          <li><button onClick={() => { setIsMobileMenuOpen(false); navigate('/register'); }} className="nav-cta">Register</button></li>
        </ul>
      </nav>
      ...
      <section id="events" className="events-section">
        ...
        <div className="events-grid">
          <div className="event-card has-bg">
            <div className="event-card-bg" style={{ 
              backgroundImage: `url(${poojaImg})`,
              backgroundPosition: 'center 20%'
            }}></div>
            <div className="event-card-content">
              <h3>Pooja</h3>
              <p>An auspicious beginning — invoking blessings and positive energy to kick off the grand celebration.</p>
            </div>
          </div>
          <div className="event-card has-bg">
            <div className="event-card-bg" style={{ 
              backgroundImage: `url(${powadaImg})`,
          ...
          <div className="event-card has-bg">
            <div className="event-card-bg" style={{ 
              backgroundImage: `url(${soloGroupImg})`,
          ...
          <div className="event-card has-bg">
            <div className="event-card-bg" style={{ 
              backgroundImage: `url(${funActivitiesImg})`,
          ...
          <div className="event-card has-bg">
            <div className="event-card-bg" style={{ 
              backgroundImage: `url(${rampWalkImg})`, 
